<template>
  <div class="modal-address-selector">
    <popup-panel
      ref="popup"
      width="1600px"
      height="800px"
      ...
      <div class="screen-search">
        <div class="screen-search-input">
          <div class="search-row">
            <div class="search-col search-col-label search-col-offset">
              <div class="input-text">已选择的{{ titleHighlight }}：</div>
            </div>
            <div class="search-col search-col-value">
              <div class="input-content current-value">{{ checkText || selectionPlaceholder }}</div>
            </div>
            <div class="search-col search-col-action">
              <button class="input-btn" type="button" @click="selectValue">{{ confirmText }}</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="screen-content">
        <div class="screen-lt">
          <div class="screen-tab">
            <div class="scroll-view scroll-Y" style="height: 100%">
              <div
              ...
              >
                ...
                <span class="arrow">
                  <img v-if="item._children.length" src="./assets/icon-arrow.png" alt="" />
                </span>
              </div>
            </div>
          </div>
        ...
        <div class="screen-rt">
          ...
          >
            <div class="scroll-view" style="height: 100%">
              <div
