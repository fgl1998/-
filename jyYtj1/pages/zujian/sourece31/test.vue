<template>
  <view class="demo-page">
    <view class="demo-card">
      ...
      <button type="button" class="demo-open-button" @click="$refs.modalAddressSelector1.open()">打开地址选择器</button>
      <modal-address-selector
        ref="modalAddressSelector1"
      ...
      <button type="button" class="demo-open-button" @click="$refs.modalAddressSelector2.open()">打开地址选择器</button>
      <modal-address-selector
        ref="modalAddressSelector2"
      ...
      <button type="button" class="demo-open-button" @click="$refs.modalAddressSelector3.open()">打开地址选择器</button>

      <modal-address-selector
        ref="modalAddressSelector3"
      ...
      <button type="button" class="demo-open-button" @click="$refs.modalAddressSelector4.open()">打开地址选择器</button>

      <modal-address-selector
        ref="modalAddressSelector4"
