  ...
  <view class="ez-declare-card-wrapper">
    <block v-for="(item, index) in renderData" :key="item.id">
      <div class="card">
        ...
        <!-- 乐山 高校毕业生艰苦边远地区基层就业学费奖补 -->
        <block v-if="type === '20317'">
          <div class="cell">
            <div class="key">就业单位全称：</div>
            <div class="value">{{ item.name }}</div>
          </div>
          <div class="cell">
          ...
          <div class="cell">
            <div class="key">单位详细地址：</div>
            <div class="value">{{ item.address }}</div>
          </div>
          <div class="cell">
            <div class="key">单位联系电话：</div>
            <div class="value">{{ item.tel }}</div>
          </div>
          <div class="cell">
            <div class="key">上级主管部门全称：</div>
            <div class="value">{{ item.superior }}</div>
          </div>
          <div class="cell">
            <div class="key">上级主管部门电话：</div>
            <div class="value">{{ item.superiorTel }}</div>
          </div>
          <div class="cell">
          ...
          <div class="cell">
            <div class="key">年度考核等次：</div>
            <div class="value">{{ item.equality }}</div>
          </div>
        </block>
        <!-- 乐山 中职国家奖学金 -->
        <block v-if="type === '20604'">
          <div class="cell">
            <div class="key">获奖日期：</div>
            <div class="value">{{ item.time }}</div>
          </div>
          <div class="cell">
            <div class="key">奖励名称：</div>
            <div class="value">{{ item.name }}</div>
          </div>
          <div class="cell">
            <div class="key">颁奖单位：</div>
            <div class="value">{{ item.company }}</div>
          </div>
        </block>
        <!-- 乐山 生猪重大动物疫病强制扑杀补助 -->
        <block v-if="type === '20416'">
          <div class="cell">
            <div class="key">禽畜种类：</div>
            <div class="value">{{ item.type }}</div>
          </div>
          <div class="cell">
            <div class="key">禽畜体重范围：</div>
            <div class="value">{{ item.weight }}</div>
          </div>
          <div class="cell">
            <div class="key">捕杀数量（头、只）：</div>
            <div class="value">{{ item.quantity }}</div>
          </div>
          <div class="cell">
            <div class="key">补助标准（元/头、只）：</div>
            <div class="value">{{ item.each }}</div>
          </div>
          <div class="cell">
      ...
      <div class="popup-con">
        ...
        <block v-if="type === '20173'">
          <div class="input-cell">
            <div class="key">动物标识号码：</div>
            <div class="value">
              <input class="input" type="number" placeholder="请输入动物标识号码" v-model="selectInfo.number" />
            </div>
          </div>
        </block>
        ...
        <block v-if="type === '20093'">
          <scroll-view class="scroll-view_H" scroll-y="true">
            ...
            <div class="input-cell">
              <div class="key">民族：</div>
              <div class="value">
                <input class="input" type="text" maxlength="18" placeholder="请输入民族" v-model="selectInfo.nation" />
              </div>
            </div>
            <div class="input-cell">
              <div class="key">联系方式：</div>
            ...
            <div class="input-cell">
              <div class="key">备注：</div>
              <div class="value">
                <input class="input" type="text" maxlength="18" placeholder="请输入备注" v-model="selectInfo.remark" />
              </div>
            </div>
          </scroll-view>
        </block>
        ...
        <block v-if="type === '20300'">
          ...
          <div class="input-cell">
            <div class="key">职业：</div>
            <div class="value">
              <input class="input" type="text" maxlength="12" placeholder="请输入职业" v-model="selectInfo.job" />
            </div>
          </div>
        </block>
        ...
        <block v-if="type === '20518_1'">
          ...
          <ComponentDeclarePicker
            ...
            @change="hanldeChangeStartTime"></ComponentDeclarePicker>
          <ComponentDeclarePicker
        ...
        <block v-if="type === '20014'">
          ...
          <div class="input-cell">
            <div class="key">年龄：</div>
            <div class="value">
              <input class="input" type="number" maxlength="3" placeholder="请输入年龄" v-model="selectInfo.age" />
            </div>
          </div>
          <ComponentDeclarePicker
            :range="relationshipStudentRange"
          ...
          <div class="input-cell">
            ...
            <div class="value">
              <input class="input" type="digit" maxlength="12" placeholder="请输入年收入" v-model="selectInfo.wages" />
            </div>
          </div>
          <ComponentDeclarePicker
            :range="healthyRange"
        ...
        <block v-if="type === '20640'">
          <div class="box-over">
            ...
            <div class="input-cell">
              <div class="key">年龄：</div>
              <div class="value">
                <input class="input" type="number" maxlength="18" placeholder="请输入年龄" v-model="selectInfo.age" />
              </div>
            </div>
            <div class="input-cell">
              <div class="key">残疾等级：</div>
            ...
            <div class="input-cell">
              <div class="key">户籍地址：</div>
              <div class="value">
                <input class="input" type="text" placeholder="请输入户籍地址" v-model="selectInfo.address" />
              </div>
            </div>
            <ComponentDeclarePicker
              mode="date"
              ...
              :endTime="today"
              placeholder="请选择聘用时间"
              v-model="selectInfo.time"></ComponentDeclarePicker>
          </div>
        </block>
        ...
        <block v-if="type === '20639'">
          ...
          <div class="input-cell">
            <div class="key">工作单位：</div>
            <div class="value">
              <input class="input" type="text" placeholder="请输入工作单位" v-model="selectInfo.work" />
            </div>
          </div>
          <div class="input-cell disabled">
            <div class="key">残疾类别：</div>
        ...
        <block v-if="type === '20457_o'">
          ...
          <ComponentDeclarePicker
            ...
            v-model="selectInfo.end"></ComponentDeclarePicker>
          ...
          <div class="input-cell">
            <div class="key">证明人：</div>
            <div class="value">
              <input class="input" type="text" maxlength="12" placeholder="请输入证明人" v-model="selectInfo.person" />
            </div>
          </div>
        </block>
        <!-- 乡村医生 离岗 -->
        ...
        <block v-if="type === '20317'">
          <div class="input-cell">
            <div class="key">就业单位全称：</div>
            <div class="value">
              <input class="input" type="text" placeholder="请输入就业单位全称" v-model="selectInfo.name" />
            </div>
          </div>
          <div class="input-cell">
            <div class="key">工作岗位：</div>
            <div class="value">
              <input class="input" type="text" placeholder="请输入工作岗位" v-model="selectInfo.job" />
            </div>
          </div>
          <div class="input-cell">
            <div class="key">单位详细地址：</div>
            <div class="value">
              <input class="input" type="text" placeholder="请输入单位详细地址" v-model="selectInfo.address" />
            </div>
          </div>
          <div class="input-cell">
            <div class="key">单位联系电话：</div>
          ...
          <div class="input-cell">
            <div class="key">上级主管部门全称：</div>
            <div class="value">
              <input class="input" type="text" placeholder="请输入上级主管部门全称" v-model="selectInfo.superior" />
            </div>
          </div>
          <div class="input-cell">
            <div class="key">上级主管部门电话：</div>
            <div class="value">
              <input
                ...
                type="number"
                maxlength="11"
                placeholder="请输入上级主管部门电话"
                v-model="selectInfo.superiorTel" />
            </div>
          </div>
          <ComponentDeclarePicker
            mode="date"
          ...
          <div class="input-cell">
            <div class="key">年度考核等次：</div>
            <div class="value">
              <input class="input" type="text" placeholder="请输入年度考核等次" v-model="selectInfo.equality" />
            </div>
          </div>
        </block>
        <!-- 乐山 中职国家奖学金 -->
        <block v-if="type === '20604'">
          ...
          <div class="input-cell">
            <div class="key">奖励名称：</div>
            <div class="value">
              <input class="input" type="text" placeholder="请输入奖励名称" v-model="selectInfo.name" />
            </div>
          </div>
          <div class="input-cell">
            <div class="key">颁奖单位：</div>
            <div class="value">
              <input class="input" type="text" placeholder="请输入颁奖单位" v-model="selectInfo.company" />
            </div>
          </div>
        </block>
        <!-- 乐山 生猪重大动物疫病强制扑杀补助 -->
        <block v-if="type === '20416'">
          <div class="input-cell">
            <div class="key">禽畜种类：</div>
            <div class="value">
              <input class="input" type="text" placeholder="请输入禽畜种类" v-model="selectInfo.type" />
            </div>
          </div>
          <div class="input-cell">
            <div class="key">禽畜体重范围：</div>
            <div class="value">
              <input class="input" type="text" placeholder="请输入禽畜体重范围" v-model="selectInfo.weight" />
            </div>
          </div>
          <div class="input-cell">
            <div class="key">捕杀数量（头、只）：</div>
            <div class="value">
              <input class="input" type="number" placeholder="请输入捕杀数量（头、只）" v-model="selectInfo.quantity" />
            </div>
          </div>
          <div class="input-cell">
            <div class="key">补助标准（元/头、只）：</div>
            <div class="value">
              <input class="input" type="number" placeholder="请输入补助标准（元/头、只）" v-model="selectInfo.each" />
            </div>
          </div>
          <div class="input-cell">
            <div class="key">申请补助金额（元）：</div>
            <div class="value">
              <input class="input" type="number" placeholder="请输入申请补助金额（元）" v-model="selectInfo.money" />
            </div>
          </div>
        </block>
  ...
  export default {
      ...
      showunit() {
        ...
        if (breed_desc || botany_desc) {
          ...
          this.unit.forEach((item) => {
            ...
            let result = item.attribute.find((one) => one == breed_desc || one == botany_desc)
            if (result) {
    ...
    methods: {
      ...
      handleCheck() {
        ...
        if (type === '20106') {
          const { type, botany, breed, n00068, n00069, n00070, n00071, n00072, n00073, n00074, n00075 } =
            this.selectInfo
          if (!type) {
            showModal('请选择类型')
            return false
          ...
          if (!n00068 && !n00069 && !n00070 && !n00071 && !n00072 && !n00073 && !n00074 && !n00075) {
            showModal('请输入数量')
            return false
          }
        }
        ...
        if (type === '20639') {
          const { name, idCard, relationship_desc, work, style, level, number } = this.selectInfo
          if (!name) {
            showModal('请输入姓名')
            return false
          }
        ...
        if (type === '20317') {
          const { name, job, address, tel, superior, superiorTel, time, equality } = this.selectInfo
          if (!name) {
            showModal('请输入就业单位全称')
            return false
          }
          ...
          if (!superior) {
            showModal('请输入上级主管部门全称')
            return false
          }
          if (!superiorTel) {
            showModal('请输入上级主管部门电话')
            return false
          }
          if (!time) {
            showModal('请选择服务时间')
        ...
        if (type === '20604') {
          const { name, time, company } = this.selectInfo
          if (!time) {
            showModal('请选择获奖日期')
            return false
          }
        ...
        if (type === '20416') {
          const { type, weight, quantity, each, money } = this.selectInfo
          if (!type) {
            showModal('请输入禽畜种类')
            return false
          }
          ...
          if (!quantity) {
            showModal('请输入捕杀数量（头、只）')
            return false
          }
          if (!each) {
            showModal('请输入补助标准（元/头、只）')
            return false
          }
          if (!money) {
