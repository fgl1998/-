<template>
  <ComponentPopup type="bottom" ref="ez_select_address_popup" @change="changeShowPopup">
                  ...
                  <block
                    ...
                    <div
                      ...
                      <i
                        ...
                        v-show="selectedAddressArr[swiperIndex][idKey] === swiperScrollViewItme[idKey]"></i>
                    </div>
                  </block>
                </scroll-view>
                <!-- 加载中 -->
                <div class="loading" v-if="requestStatusArr[swiperIndex] && requestStatusArr[swiperIndex].isLoading">
  ...
  export default {
    ...
    methods: {
      ...
      requestData(orgid, orglevel, times = 0) {
        ...
        if (this.customRequestParams && this.customRequestParams.costomno) {
          params = {
            ...params,
            costomno: this.customRequestParams.costomno
          }
        }
      ...
      updateSelectedAddressArr(newObj, index) {
        ...
        let arr = []
        if (len > 0) {
          newSelectedAddressArr.forEach((item, i) => {
            if (i < index) {
              arr.push(item)
            }
          })
      ...
      handleCiliSwiperScrollViewItem(i, j) {
        ...
        //console.log(123, 2355, renderDataArr,clickSelectItem)
