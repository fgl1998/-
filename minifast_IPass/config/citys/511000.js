...
const config511000 = {
  ...
  areaName_zh: '内江',
  // 补贴项目存放包名
  declarePackageName: 'packageDeclare511000',
  ...
  // 是否开启用户行为采集
  isOpenUserBehaviorCollection: false,
  ...
  // 是否开启语音投诉
  isOpenVoiceComplaints: true,
  //是否开启审批投诉反馈功能
  isOpenSPComplaintFeedback: true,
  // 智能客服 猜你想问 配置
  ...
  configClosePageModule: {
    pageTabbarHome: {
      ...
      helpVideo: true, // 帮助视频
      annualAccount: '2' // 年度盘点 0 关闭 1 简洁版 2 叙事版
    },
    pageTabbarMy: {
      myHome: false, // 我的家
