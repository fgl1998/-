...
const config511100 = {
  requestUrl, // api 请求地址
  areaCode: '511100', // 行政区域编码 乐山 511500
  areaName_zh: '乐山', // 行政区域中文名称/简称 乐山
  declarePackageName: 'packageDeclare511100', // 补贴项目存放包名
  // 控制政策文件的请求地址 true 请求发放系统 false 请求审批审批
  isRequestYGFF: false,
  // 是否开启阳光发放请求 true 开启 兼容甘孜
  isOpenYGFF: false,
  // 是否通过德生接口替代发放系统请求 true 开启 兼容乐山
  isOpenYGFFByDS: true,
  // 是否开启个人补贴查询
  ...
  aMapKey: '2cbe581657fd0e71767715f559fe5908' // 高德地图密钥
}

export default config511100
