        ...
        <div class="panel-content">
          <div class="cell-items">
						...
						<ComponentDeclarePicker
						  label="手术类别"
						  :range="codeMap.c00278"
						  placeholder="请选择手术类别"
						  v-model="projectDeclareInfo.c00278"
						></ComponentDeclarePicker>
...
export default {
  ...
  methods: {
    async getCodeTableCacheData() {
      ...
      try {
        c00278 = await getCodeListByCodeName('c00278')
      } catch (err) {
        if (isDev) {
          console.log('code table c00278 error：', err)
        }
      }
