        ...
        <div class="panel-content">
          <div class="cell-items">
            <ComponentDeclarePicker
              label="受理村"
              :range="codeMap.chb018"
              placeholder="请选择受理村"
              v-model="projectDeclareInfo.chb018"
            ></ComponentDeclarePicker>

            <div class="cell-item required">
              <div class="key">儿童福利系统编号</div>
              <div class="value">
                <input
                  type="text"
                  v-model="projectDeclareInfo.m00104"
                  placeholder="请输入儿童福利系统编号"
                />
              </div>
            </div>
...
export default {
  ...
  methods: {
    async getCodeTableCacheData() {
      ...
      try {
        chb018 = await getCodeListByCodeName('chb018')
      } catch (err) {
        if (isDev) {
          console.log('code table chb018 error：', err)
        }
      }
