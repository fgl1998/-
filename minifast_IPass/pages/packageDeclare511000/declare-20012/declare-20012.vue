        ...
        <div class="panel-content">
          <div class="cell-items">
            ...
            <ComponentDeclarePicker
              label="录取院校位置"
              idName="j51002"
              :range="codeMap.j00089"
              placeholder="请选择或输入录取院校位置"
              v-model="projectDeclareInfo.j51002"></ComponentDeclarePicker>
            <ComponentDeclarePicker
              label="学历层次"
              idName="j00074"
  ...
  export default {
    ...
    methods: {
      ...
      async getCodeTableCacheData() {
        ...
        try {
          j00089 = await getCodeListByCodeName('j00089')
        } catch (err) {
          console.error('code table j00089 error', err)
        }
        try {
      ...
      handleJumpNextStep() {
        ...
        // 扩展字段
        const hb00BizMap = {
          chb015: this.projectDeclareInfo.j00000,
          chb017: this.projectDeclareInfo.j00001,
          aac004: gender, //性别
          aac005: nation, //民族
