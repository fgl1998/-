    ...
    methods: {
      ...
      handlePickerChange(id, val_desc, val) {
        if (id === 'j00000') {
          ...
          // 市本级
          if (val === '165015') {
            this.chi031 = '20014' // 申报项目编码
            this.chi031_desc = '市本级普通高中国家助学金' // 申报项目中文
          } else {
            // 县级
            this.chi031 = '20013' // 申报项目编码
            this.chi031_desc = '县级普通高中国家助学金' // 申报项目中文
          }
        }
        if (id === 'j00001') {
          this.$store.commit(M_UPDATE_USER_LIST, {
        ...
        if (chb0g5 === '1') {
          ...
          if (j00000 === '165015') {
            this.$store.commit(UPDATE_OTHERS_DECLARE_INFO, {
              chi031: '20015',
              chi031_desc: '市本级免除普通高中家庭经济困难学生学费'
            })
          } else {
            // 县级
            this.$store.commit(UPDATE_OTHERS_DECLARE_INFO, {
              chi031: '20016',
              chi031_desc: '县级免除普通高中家庭经济困难学生学费'
            })
          }
        }
