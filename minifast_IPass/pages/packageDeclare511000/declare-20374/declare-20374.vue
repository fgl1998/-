          ...
          <div class="cell-items">
            ...
            <block>
              <ComponentDeclarePicker
                ...
                placeholder="请选择是否住宿"
                v-model="stay"></ComponentDeclarePicker>
            </block>
  ...
  export default {
    ...
    computed: {
      ...
      chiChange() {
        ...
        let str = ''
        if (j00000 && this.stay) {
          console.log(j00000, this.stay)
          // 市本级
          if (j00000 === '165015') {
            this.chi031 = '20019' // 申报项目编码
            this.chi031_desc = '市本级中等职业国家助学金' // 申报项目中文
            if (this.stay == '0') {
              this.chi031_desc = '市本级对义务教育家庭经济困难非寄宿生补助生活费'
              this.chi031 = '20374'
              str = '20374'
            } else {
              this.chi031_desc = '市本级对义务教育家庭经济困难寄宿生补助生活费'
              this.chi031 = '20017'
              str = '20017'
            }
          } else {
            if (this.stay == '0') {
              this.chi031_desc = '县级对义务教育家庭经济困难寄宿生补助生活费 '
              this.chi031 = '20375'
              str = '20375'
            } else {
              this.chi031_desc = '县级对义务教育家庭经济困难寄宿生补助生活费 '
