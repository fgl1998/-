        ...
        <div class="panel-content">
          <div class="cell-items">
            ...
            <ComponentDeclarePicker
              ...
              :renderValue="projectDeclareInfo.j00000desc"
              :isDemo="userInfo.idCard == '511002198812031225'"
            ...
            <block v-if="projectDeclareInfo.j00000">
              <ComponentDeclarePicker
                ...
                :renderValue="projectDeclareInfo.j00001desc"
                :isDemo="userInfo.idCard == '511002198812031225'"
                @change="handlePickerChange"></ComponentDeclarePicker>
            </block>
            ...
            <block v-if="projectDeclareInfo.j00001">
              <ComponentDeclarePicker
                ...
                :renderValue="projectDeclareInfo.j00011desc"
                :isDemo="userInfo.idCard == '511002198812031225'"
                @change="handlePickerChange"></ComponentDeclarePicker>
            </block>
            ...
            <block v-if="projectDeclareInfo.j00011">
              <ComponentDeclarePicker
                ...
                valueKey="orgid"
                placeholder="请选择班级"
                :renderValue="projectDeclareInfo.j00012desc"
                :isDemo="userInfo.idCard == '511002198812031225'"
            ...
            <div class="cell-item required">
              ...
              <div class="value">
                <input type="number" maxlength="6" v-model="projectDeclareInfo.j00048" placeholder="请输入邮政编码" />
              </div>
            </div>
...
<script>
  ...
  import { EDIT_SUBSIDY_INFO, USER_INFO, UPDATE_EDIT_SUBSIDY_INFO, M_UPDATE_USER_LIST } from '@/store/constants'

  export default {
    name: 'pageDeclare20376',
    data() {
      return {
        // 基本信息 渲染配置
        renderObj: {
    ...
    methods: {
      ...
      setDefaultData() {
        ...
        if (idCard == '511002198812031225') {
          this.projectDeclareInfo = {
            ...
            j00000desc: '东兴区',
            j00001: '165077',
            j00001desc: '内江市东兴初级中学校',
            j00011: '966041',
            j00011desc: '初中2021级',
            j00012: '966042',
            j00012desc: '初中2021级01班',
            j00018: '511002198812031225G',
            j00048: '641000',
            j00049: '15868593256'
          }
        }
        ...
        //     j00000: '165003',
        //     j00000desc: '东兴区',
        //     j00018: '511011200707284606G',
        //     j00048: '641100',
        //     j00049: '13258199189',
        //     j03502: '511011199307281507', //户主身份证号
        //     j03501: '张力', //户主姓名
        //     j00243: '张力' //父亲或母亲姓名
        //   }
        //   this.requestSchoolOrgByPid('165003').then((res) => {
      ...
      handlePickerChange(id, val_desc, val) {
        if (id === 'j00000') {
          ...
          // 市本级
          if (val === '165015') {
            this.chi031 = '20376' // 申报项目编码
            this.chi031_desc = '市本级中等职业国家助学金' // 申报项目中文
          } else {
            // 县级
            this.chi031 = '20080' // 申报项目编码
            this.chi031_desc = '县级中等职业教育国家助学金' // 申报项目中文
          }
        }
        if (id === 'j00001') {
          this.$store.commit(M_UPDATE_USER_LIST, {
      ...
      handleJumpNextStep() {
        ...
        const { nation, gender, nativePlace, nature, district, township, village } = this.basicInfo
        const {
          j00000, // 学校所属区县
          j00001, // 学校
          j00001desc, // 学校名称
    ...
    computed: {
      ...mapGetters([EDIT_SUBSIDY_INFO, USER_INFO]),
      // 获取家庭人均年收入
      getChb0g3() {
        const familyMemberList = this.familyMemberList
