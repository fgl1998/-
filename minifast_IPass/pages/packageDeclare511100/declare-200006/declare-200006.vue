        ...
        <div class="panel-content">
          <div class="cell-items">
            ...
            <ComponentDeclarePicker
              label="学历类型"
              idName="j00159"
              :range="codeMap.j00159"
              rangeKey="aaa103"
              valueKey="aaa102"
              placeholder="请选择学历类型"
              v-model="projectDeclareInfo.j00159"
            ></ComponentDeclarePicker>
          </div>
        </div>
      </ComponentPanel>
...
export default {
  ...
  methods: {
    ...
    async getCodeTableCacheData() {
      ...
      try {
        j00159 = await getCodeListByCodeName('J00159')
      } catch (err) {
        console.error('code table j00159 error：', err)
      }
    ...
    handleCheckInput() {
      const { chb0g1, j00001, j00158, j00159 } = this.projectDeclareInfo
