        ...
        <div class="panel-content">
          <div class="cell-items">
            <div class="cell-item required">
              <div class="key">补贴月数</div>
              <div class="value">
                <input
                  type="number"
                  v-model="projectDeclareInfo.r00179"
                  placeholder="请输入补贴月数"
                />
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    handleCheckInput() {
      const { r00179 } = this.projectDeclareInfo
      if (!r00179) {
        showModal('请输入补贴月数')
        return false
      }
    ...
    handleJumpNextStep() {
      ...
      const { gender, idCard, permanentAddress, currentAddress } =
        this.basicInfo
