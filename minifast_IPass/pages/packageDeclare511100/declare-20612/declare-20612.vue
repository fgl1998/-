        ...
        <div class="panel-content">
          <div class="cell-items">
            <div class="cell-item required">
              <div class="key">培训单位</div>
              <div class="value">
                <input
                  type="text"
                  v-model="projectDeclareInfo.chbabh"
                  placeholder="请输入培训单位"
                />
              </div>
            </div>
            <div class="cell-item required">
              ...
              <div class="value">
                <input
                  type="text"
                  v-model="projectDeclareInfo.chbabk"
                  placeholder="请输入补贴标准"
                />
              </div>
            </div>
            <div class="cell-item required">
              ...
              <div class="value">
                <input
                  type="text"
                  v-model="projectDeclareInfo.chbabi"
                  placeholder="请输入培训项目"
                />
              </div>
            </div>
            <div class="cell-item required">
              <div class="key">参训天数</div>
              <div class="value">
                <input
                  type="number"
                  v-model="projectDeclareInfo.chbabj"
                  placeholder="请输入参训天数"
                />
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    handleCheckInput() {
      const { chbabh, chbabk, chbabi, chbabj, aae019 } = this.projectDeclareInfo
    ...
    handleJumpNextStep() {
      ...
      const { permanentAddress, idCard, currentAddress } = this.basicInfo

      const { chbabh, chbabk, chbabi, chbabj, aae019 } = this.projectDeclareInfo
      const birthday = useGetBirthdayByIDCard(idCard)
      // 扩展字段
      const hb00BizMap = {
        chab10: permanentAddress, // 户籍地址
        chab2: currentAddress, // 家庭住址
        chbabh, // 培训单位
        chbabk, // 补贴标准
        chbabi, // 培训项目
        chbabj, // 参训天数
        chbabl: birthday, // 出生年月
        aae019, // 发放金额
        chb01m: '1', // 发放类型 正常发放
