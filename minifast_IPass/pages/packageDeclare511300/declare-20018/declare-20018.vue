        ...
        <div class="panel-content">
          <div class="cell-items">
            ...
            <!-- <ComponentDeclarePicker
              ...
              placeholder="请选择申报学期"
              v-model="projectDeclareInfo.chb0gf"
              @change="getPickerValueDesc"
            ></ComponentDeclarePicker> -->
            <div class="cell-item required disabled">
            ...
            <div class="cell-item textarea last">
              ...
              <div class="value">
                <textarea
                  ...
                  v-model="projectDeclareInfo.chb0gd"
                ></textarea>
              </div>
            </div>
          </div>
...
import { showModal, hideLoading, showLoading, navigateBack } from '@/utils/uni-api'
...
export default {
  ...
  methods: {
    ...
    async getCodeTableCacheData() {
      ...
      try {
        j00010c = await getCodeListByCodeName('j00010c')
      } catch (err) {
        console.error('code table j00010c error：', err)
      }
  ...
  computed: {
    ...
    getAae019() {
      let { j00010 } = this.projectDeclareInfo
      let { j00001 } = this.projectDeclareInfo
      if (j00010 && j00001) {
        if (
          j00001 == '1556039' ||
          j00001 == '2261094' ||
