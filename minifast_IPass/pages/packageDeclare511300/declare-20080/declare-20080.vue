        ...
        <div class="panel-content">
          <div class="cell-items">
            ...
            <ComponentDeclarePicker
              label="家庭经济困难情况"
              idName="j00110"
              :range="codeMap.chbbi8"
              v-model="projectDeclareInfo.j00110"></ComponentDeclarePicker>

            <ComponentDeclarePicker
              label="是否同时享受国家助学金价格临时补贴"
              idName="j00050"
              :range="codeMap.yesorno"
              v-model="projectDeclareInfo.j00050"></ComponentDeclarePicker>
            ...
            <ComponentDeclareRadio
              ...
              renderKey="name"
              aglin=""
              v-model="projectDeclareInfo.chb0g7"></ComponentDeclareRadio>
...
<script>
  ...
  import { showModal, hideLoading, navigateBack, showLoading } from '@/utils/uni-api'
  ...
  export default {
    ...
    methods: {
      ...
      handleCheckInput() {
        ...
        if (!j00050) {
          showModal('请选择是否同时享受国家助学金价格临时补贴')
          return false
        }
        if (!j00019) {
          showModal('请填写监护人姓名')
