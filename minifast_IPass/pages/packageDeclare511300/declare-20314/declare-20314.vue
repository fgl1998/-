...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handleBeforeCheck() {
        //数据更新之后再进行提示操作,没有这两个属性则没有更新
        if (!this.basicInfo.hasOwnProperty('idCard') || !this.basicInfo.hasOwnProperty('userName')) {
          return
        }
      ...
      // 选择家庭经济困难情况
      changeRadioJ00110(value) {
        const data = this.difficultyType
        this.projectDeclareInfo = {
          ...this.projectDeclareInfo,
          j00110: value
        }
