        ...
        <div class="panel-content">
          <div class="cell-items">
            ...
            <div class="cell-item required">
              <div class="key">项目地址</div>
              <div class="value">
                <input
                  type="text"
                  v-model="projectDeclareInfo.c00235"
                  placeholder="请输入项目地址"
                />
              </div>
            </div>
  ...
  methods: {
    ...
    async getCodeTableCacheData() {
      ...
      try {
        ...
        console.error('code table c00128 error：', err)
      }
    ...
    handleJumpNextStep() {
      ...
      var hb00BizMap = {
        ...
        // chb0h2, // 残疾人等级
        c03601, // 残疾证号
        aae006: currentAddress, // 户籍地址
        c00033: permanentAddress, // 家庭地址
      }
