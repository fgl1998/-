        ...
        <div class="panel-content">
          <div class="cell-items">
            <ComponentSelectAddressMultitype
              ...
              @clickBtn="projectDeclareInfo.chb0he = basicInfo.permanentAddress"
            ...
            <ComponentDeclarePicker
              label="择业类型"
              idName="c00078"
              :range="codeMap.c00078"
              placeholder="请选择择业类型"
              v-model="projectDeclareInfo.c00078"
            >
            </ComponentDeclarePicker>

            <ComponentSelectAddressMultitype
              label="就业(创业)项目地址"
              placeholder="请选择就业(创业)项目地址"
              :isShowBtn="renderObj.permanentAddress"
...
export default {
  ...
  methods: {
    ...
    async getCodeTableCacheData() {
      ...
      try {
        c00078 = await getCodeListByCodeName('c00078')
      } catch (err) {
        console.error('code table c00078 error：', err)
      }
    ...
    handleJumpNextStep() {
      ...
      // const nowAdress = this.nowAdress
      // const CyAdress = this.CyAdress
      const {
        c00078, // 择物类型
        chb0h1, // 残疾人类别
        chb0h2, // 残疾人等级
