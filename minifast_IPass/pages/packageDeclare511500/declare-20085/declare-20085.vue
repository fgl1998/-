      ...
      <ComponentPanel title="申报信息">
        <div class="panel-content">
          <div class="cell-items">
            ...
            <div class="cell-item required">
              <div class="key">工商注册或民政登记证书编号</div>
              <div class="value">
                <input
                  type="number"
                  maxlength="20"
                  v-model="projectDeclareInfo.r00088"
                  placeholder="请输入"
                />
              </div>
            </div>
            ...
            <div class="cell-item textarea last required">
              <div class="key">创业实体概述</div>
              <div class="value">
                <textarea
                  maxlength="100"
                  placeholder="请输入创业实体概述"
                  v-model="projectDeclareInfo.r00075"
                ></textarea>
              </div>
            </div>
          </div>
