        ...
        <div class="panel-content">
          <div class="cell-items">
            ...
            <ComponentDeclarePicker
              label="申报类型"
              idName="c00019"
              :range="codeMap.c00019"
              placeholder="请选择申报类型"
              v-model="projectDeclareInfo.c00019"
            >
            </ComponentDeclarePicker>
            <ComponentDeclarePicker
              label="家庭经济情况"
...
export default {
  ...
  methods: {
    ...
    async getCodeTableCacheData() {
      ...
      try {
        c00019 = await getCodeListByCodeName('c00019')
      } catch (err) {
        console.error('code table c00019 error：', err)
      }
      try {
        c00129 = await getCodeListByCodeName('c00129')
      } catch (err) {
        console.errorerror('code table c00129 error：', err)
      }
