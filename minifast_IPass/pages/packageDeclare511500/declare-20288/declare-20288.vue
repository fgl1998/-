        ...
        <div class="panel-content">
          <div class="cell-items">
            ...
            <ComponentDeclarePicker
              label="申请补贴种类"
              idName="c00077"
              :range="codeMap.c00077"
              placeholder="请选择申请补贴种类"
              v-model="projectDeclareInfo.c00077"
            >
            </ComponentDeclarePicker>
            <div class="cell-item required">
              <div class="key">安装假肢的费用</div>
              <div class="value">
                <input
                  type="number"
                  maxlength="11"
                  v-model="projectDeclareInfo.c00076"
                  placeholder="请输入安装假肢的费用"
                />
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    async getCodeTableCacheData() {
      ...
      try {
        c00077 = await getCodeListByCodeName('c00077')
      } catch (err) {
        console.error('code table c00077 error：', err)
      }
    ...
    handleJumpNextStep() {
      ...
      const { age, permanentAddress } = this.basicInfo
