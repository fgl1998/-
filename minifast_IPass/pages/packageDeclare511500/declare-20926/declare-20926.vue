        ...
        <div class="panel-content">
          <div class="cell-items">
            ...
            <ComponentDeclarePicker
              ...
              v-model="projectDeclareInfo.c00050"
            >
            </ComponentDeclarePicker>
            <div class="cell-item required">
              ...
              <div class="value">
                <input
                  type="number"
                  maxlength="11"
                  v-model="projectDeclareInfo.c00080"
                  placeholder="请输入家庭人均年收入"
                  @input="handleCheckNumber($event, 'c00080')"
                />
              </div>
            </div>
            <div class="cell-item required">
              <div class="key">驾驶证号码</div>
              <div class="value">
                <input
                  type="number"
                  v-model="projectDeclareInfo.c00081"
                  placeholder="请输入驾驶证号码"
                  @input="handleCheckNumber($event, 'c00081')"
                />
              </div>
            </div>
            <ComponentDeclarePicker
            ...
            ></ComponentDeclarePicker>
            <ComponentDeclarePicker
              v-if="projectDeclareInfo.c00082"
              label="有效期限开始"
              idName="c00083"
              mode="date"
              fields="day"
              :startTime="projectDeclareInfo.c00082"
              :endTime="new Date().getTime()"
              placeholder="请选择有效期限开始日期"
              v-model="projectDeclareInfo.c00083"
            ></ComponentDeclarePicker>
            <ComponentDeclarePicker
              v-if="projectDeclareInfo.c00082"
              label="有效期限结束"
              ...
              fields="day"
              :startTime="projectDeclareInfo.c00082"
              placeholder="请选择有效期限结束日期"
              v-model="projectDeclareInfo.c00084"
            ></ComponentDeclarePicker>
          </div>
        </div>
      </ComponentPanel>
...
export default {
  ...
  methods: {
    ...
    handleCheckInput() {
      ...
      if (!c00083) {
        showModal('请选择有效期限开始日期')
        return false
      }
      if (!c00084) {
        showModal('请选择有效期限结束日期')
        return false
      }
      if (!c03601) {
