        ...
        <div class="panel-content">
          <div class="cell-items">
            ...
            <div class="cell-item required">
              <div class="key">灵活就业项目</div>
              <div class="value">
                <input type="text" v-model="projectDeclareInfo.c00339" placeholder="请输入灵活就业项目" />
              </div>
            </div>
            ...
            <div class="cell-item required">
              ...
              <div class="value">
                <input type="text" v-model="projectDeclareInfo.c00231" placeholder="请输入项目规模" />
              </div>
            </div>
            ...
            <div class="cell-item required">
              ...
              <div class="value">
                <input type="text" v-model="projectDeclareInfo.c00261" placeholder="请输入营业执照号码" />
              </div>
            </div>
            ...
            <div class="cell-item required">
              ...
              <div class="value">
                <input type="number" v-model="projectDeclareInfo.aae019" placeholder="请输入申请金额" />
              </div>
            </div>
          </div>
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      handleCheckInput() {
        ...
        if (!c00339) {
          showModal('请输入灵活就业项目', '提示', false)
          return false
        }
        if (!c00231) {
          showModal('请输入项目规模', '提示', false)
          return false
        }
        if (!c00260) {
