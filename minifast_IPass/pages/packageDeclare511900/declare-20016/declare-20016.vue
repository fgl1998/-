...
export default {
  ...
  methods: {
    ...
    async getCodeTableCacheData() {
      let j00011_2 = [] // 年级
      try {
        j00011_2 = await getCodeListByCodeName('j00011_2')
      } catch (err) {
        console.error('code table j00011_2 error：', err)
      }
      this.codeMap = {
        ...this.codeMap,
        j00011_2,
    ...
    handleDistrictChange() {
      ...
      showLoading()
      Promise.all([
        this.requestSchoolData(j00000, '01'),
        this.requestSchoolData(j00000, '02'),
        this.requestSchoolData(j00000, '03'),
      ])
        .then((res) => {
          this.schoolRange = [...res[0], ...res[1], ...res[2]]
          hideLoading()
        })
        .catch(() => {
          hideLoading()
