        ...
        <div class="panel-content">
          <div class="cell-items">
            ...
            <ComponentDeclarePicker
              ...
              mode="date"
              placeholder="请选择办证时间"
              v-model="projectDeclareInfo.chb0h9"
            ></ComponentDeclarePicker>
          </div>
        </div>
      </ComponentPanel>
...
export default {
  ...
  methods: {
    ...
    handleJumpNextStep() {
      ...
      const isUnderAge = this.isUnderAge // 是否未成年
  ...
  watch: {
    'basicInfo.district': {
      handler(val) {
        if (val == '100280') {
          this.chi031 = '20141' // 申报项目编码
          this.chi031_desc = '市级残疾人紧急救助金' // 申报项目中文
        } else {
          this.chi031 = '20140' // 申报项目编码
          this.chi031_desc = '县级残疾人紧急救助金' // 申报项目中文
        }
      },
      immediate: true,
    },
