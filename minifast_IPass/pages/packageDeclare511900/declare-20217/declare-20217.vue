            ...
            <!-- 							<div class="cell-item">
							  ...
							  <div class="value">
							    <input
							      ...
							      placeholder="请输入班级"
										@input='handleCheckNumber($event,"j00012")'
							    />
							  </div>
							</div> -->
          </div>
...
export default {
  ...
  methods: {
    ...
    async getCodeTableCacheData() {
      ...
      let j00097 = [] // 贫困类型
      try {
        j00011_1 = await getCodeListByCodeName('j00011_1')
      } catch (err) {
        console.error('code table j00011_1 error：', err)
      }
      try {
