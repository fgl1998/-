      ...
      <div class="popup-con">
        ...
        <block v-if="type === '200182'">
          <div class="input-cell">
            <div class="key">姓名：</div>
            <div class="value">
              <input class="input" type="text" placeholder="请输入姓名" v-model="selectInfo.name" />
            </div>
          </div>
          <div class="input-cell">
            <div class="key">年龄：</div>
          ...
          <div class="input-cell">
            <div class="key">从事职业：</div>
            <div class="value">
              <input class="input" type="text" placeholder="请输入从事职业" v-model="selectInfo.job" />
            </div>
          </div>
        </block>
  ...
  export default {
    ...
    methods: {
      ...
      handleCheck() {
        ...
        if (type === '200182') {
          const { name, job, age, relationship_desc } = this.selectInfo
          if (!name) {
            showModal('请输入姓名')
            return false
          }
