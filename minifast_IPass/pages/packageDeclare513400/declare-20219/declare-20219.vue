            ...
            <div class="cell-item required">
              ...
              <div class="value">
                <input
                  ...
                  placeholder="请输入发放金额"
                  @input="handleCheckNumber($event, 'aae019')"
                />
              </div>
            </div>
          </div>
  ...
  methods: {
    ...
    async getCodeTableCacheData() {
      ...
      try {
        ...
        j00010_1 = await getCodeListByCodeName("j00010_1");
      } catch (err) {
        if (isDev) {
          console.log("code table chp031_1 error：", err);
          console.log("code table j00010_1 error：", err);
        }
      }
    ...
    handleJumpNextStep() {
      ...
      let hb00BizMap = {
        aac005: nation, // 民族
        aac004: gender, // 性别
        aae006: permanentAddress, // 详细地址

        j00010, // 学段
        j00001, // 学校
        j00011, // 年级
        aae019: parseInt(aae019), // 发放金额
