          ...
          <ComponentPanel title="被举报对象信息">
            <div class="panel-content">
              <div class="input-wrapper required">
                <div class="label">被举报对象姓名/企业名称</div>
                <div class="input">
                  <input type="text" v-model="formData.aac003" placeholder="请输入被举报对象的姓名/企业名称" />
                </div>
              </div>
              ...
              <div class="input-wrapper">
                ...
                <div class="input">
                  <input type="text" v-model="formData.aae209" placeholder="请输入被举报发放期号" />
                </div>
              </div>
              <div class="input-wrapper">
                <div class="label">被举报发放金额(元)</div>
                <div class="input">
                  <input type="number" v-model="formData.aae019" placeholder="请输入被举报发放金额" />
                </div>
              </div>
            </div>
          </ComponentPanel>
          ...
          <ComponentPanel title="举报人信息">
            <div class="panel-content">
              <div class="input-wrapper required">
                ...
                <div class="input">
                  <input type="text" :value="useTMUserName(formData.chb581)" disabled placeholder="请输入您的姓名" />
                </div>
              </div>
              <div class="input-wrapper required">
                ...
                <div class="input">
                  <input
                    type="idcard"
                    :value="useTMIDCard(formData.chb582)"
                    disabled
                    maxlength="18"
              ...
              <div class="input-wrapper required">
                ...
                <div class="input">
                  <input
                    type="number"
                    :value="useTMPhone(formData.chb583)"
                    disabled
                    maxlength="11"
                ...
                <div class="input-wrapper required">
                  ...
                  <div class="input">
                    <picker
                      ...
                      range-key="orgname"
                      mode="selector"
                      :value="pickerAae016Value"
                      @change="handleAae016ChangePicker">
                      <div class="picker-content">
                        <div class="picker-value" v-if="formData.aae006">
                          {{ formData.aae006_desc }}
                        </div>
                        <div class="picker-placeholder" v-else>请选择所在区县</div>
                        <div class="iconimg"></div>
                      </div>
                    </picker>
                  </div>
          ...
          <ComponentPanel title="举报内容">
            <div class="panel-content">
              ...
              <div class="input-wrapper required">
                ...
                <div class="input">
                  <input type="text" v-model="formData.chb092" placeholder="请输入投诉标题" />
                </div>
              </div>
              <div class="input-wrapper required">
...
<script>
  ...
  import { requestB016, requestSPSaveHb09, requestSPGetOrgListByOrgId, requestFFGetBhi031ByChi031 } from '@/service/api'
  import { checkIDCard } from '@/utils/check'
  import { getCodeListByCodeName } from '@/utils/custom-api'
  import { useTMUserName, useTMIDCard, useTMPhone } from '@/hooks'
  ...
  export default {
    ...
    methods: {
      ...
      // 区县选择
      handleAae016ChangePicker(e) {
        const { value } = e.target
        const item = this.schoolRange[value]
        this.pickerAae016Value = value + ''
        this.formData = {
          ...this.formData,
          aae006: item.orgid,
          aae006_desc: item.orgname
        }
      },
      // 请求获得全部的补贴项目
      getChi031Range() {
        ...
        if (areaCode === '510100') {
          let arr = []
          getCodeListByCodeName('chi031', 'ygff').then((res) => {
      ...
      checkInput() {
        ...
        if (!this.radioValue && areaCode !== '511000') {
