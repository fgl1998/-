...
import {
  requestWXCreatePolicyFilePdf,
  requestWXDeletePolicyFilePdf,
} from '@/service/api'
/**
 * 预览 pdf
...
const previewPDFAlipay = (chi050, fileType = 'pdf') => {
  ...
  return new Promise((resolve, reject) => {
    requestWXCreatePolicyFilePdf(chi050, false).then((res) => {
            ...
            if (tempFilePath) {
              openDocument(tempFilePath, fileType)
                ...
                .finally(() => {
                  ...
                  requestWXDeletePolicyFilePdf(newFileName, false)
                    .then(() => {})
                    .finally(() => {
                      hideLoading()
                    })
