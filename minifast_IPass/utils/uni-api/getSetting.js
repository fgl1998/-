 ...
 * @see {@link https://developers.weixin.qq.com/miniprogram/dev/api/open-api/setting/wx.getSetting.html | 微信小程序官方文档}
 * @see {@link https://uniapp.dcloud.net.cn/api/other/setting.html#getSetting | uni-app官方文档}
 * @returns {Promise<Res>}
 * @example
 * getSetting().then(res => {
 *    // 接口调用成功
 ...
 * })
 */
const getSetting = (withSubscriptions = true) => {
  // 当前环境是否为开发环境
