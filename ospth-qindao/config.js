 ...
 */
// 开发环境后台请求地址
const BASE_URL_DEV = 'http://192.168.72.10:8080/osp-tb/api'
// 办事页面路径
const BASE_IP_DEV = 'http://192.168.78.161:30001/osp-tb'
// 加密级别：0.不做任何处理 1.加密 2.加密+签名 3.加密+签名+时间戳
const CRYPT_TYPE_DEV = '0'
// 返回数据解密 false不解密，true解密
const BACK_DECRYPT_DEV = false
// 开发环境资源请求路径
const IMAGE_SRC_DEV = 'http://192.168.72.10:8080/osp-tb/osp-tb/template'
// uni.scss中配置的资源请求路径
const UNI_SCSS_SRC_DEV = 'http://192.168.72.10:8080/osp-tb/osp-tb/template'

/**
 * 测试环境
 */
// 测试环境后台请求地址
const BASE_URL_TEST = 'http://127.0.0.1:8080/osp-tb/api'
// 办事页面路径
const BASE_IP_TEST = 'http://172.20.21.93:30001/osp-tb'
// 加密级别：0.不做任何处理 1.加密 2.加密+签名 3.加密+签名+时间戳
const CRYPT_TYPE_TEST = '3'
// 返回数据解密 false不解密，true解密
const BACK_DECRYPT_TEST = true
// 测试环境资源请求路径
const IMAGE_SRC_TEST = 'http://192.168.73.97:8080/osp-tb/osp-tb/template'
// uni.scss中配置的资源请求路径
const UNI_SCSS_SRC_TEST = 'http://192.168.73.97:8080/osp-tb/osp-tb/template'
