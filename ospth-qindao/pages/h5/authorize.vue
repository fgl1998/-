	...
	export default {
		...
		onLoad(options) {
			...
			if (!this.formData || !this.formData.areaCode) {
				...
				if(this.formData.areaCode.substring(0,4) == '6599'){
					this.areaCode = this.formData.areaCode.substring(0,4)+'00'+'000000'
					uni.setStorageSync("areaCode",this.areaCode)
				}else {
					this.areaCode = this.formData.areaCode.substring(0,4)+'99'+'000000'
					uni.setStorageSync("areaCode",this.areaCode)
				}
