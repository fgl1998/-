...
const stepMap = [
  ...
  {
    title: '新建商品房支付首付款', component: two, previous: ENUMS.STEP.GO_BACK, next: ENUMS.STEP.ONE
  },
  {
    title: '新建商品房支付首付款', component: three, previous: ENUMS.STEP.ZERO, next: ENUMS.STEP.FINISH,
    sceneCode: 'S0000',
