...
<script>
	import mixin from '@osppm/store/person/fetch/paymentTransfer/one/mixin'
	import {
		mapActions,
		mapMutations,
		mapState
	...
	export default {
		...
		mixins: [mixin],
		computed: {
			...mapState('paymentTransfer', ['oneformData'])
		},
		data() {
			return {
		...
		methods: {
			...mapMutations('paymentTransfer', ['setFormData']),
			...mapActions('paymentTransfer', ['saveForm']),
