		...
		<view class="uform">
			<u-form :model="infoForm" ref="infoForm" label-position="left" :rules="rules">
				...
				<!-- <u-form-item label="期望工作地点" prop="acb202" label-width="150" required>
					...
					<view class="addressBox" @click="openArea('infoForm','acb202_desc')"></view>
				</u-form-item> -->
				<!-- 区域选择组件-全国 -->
				<!-- <u-form-item label="期望工作地点" prop="acb202" label-width="150" required>
				...
				<u-form-item label="性别" prop="aac004" label-width="150" required>
					<mini-picker :disabled="isDisabled" disabled placeholder="请选择性别" selectPrompt="请选择性别"
				...
				<u-form-item label="民族" prop="aac005" label-width="150" required>
					<mini-picker :disabled="isDisabled" placeholder="请选择民族" selectPrompt="请选择民族" collection="AAC005"
				...
				<u-form-item label="户口性质" prop="aac009" label-width="150" required>
					<mini-picker :disabled="isDisabled" placeholder="请选择户口性质" selectPrompt="请选择户口性质" collection="AAC009"
				...
				<u-form-item label="个人身份" prop="ycc022" label-width="150">
					<mini-picker :disabled="isDisabled" placeholder="请选择个人身份" selectPrompt="请选择个人身份" collection="YCC022"
				...
				<u-form-item label="文化程度" prop="aac011" label-width="150" required>
					<mini-picker :disabled="isDisabled" placeholder="请选择文化程度" selectPrompt="请选择文化程度" collection="AAC011"
				...
				<u-form-item label="就业形式" prop="yhc407" label-width="150" required>
					<mini-picker :disabled="isDisabled" placeholder="请选择就业形式" selectPrompt="请选择就业形式" collection="ADC111"
				...
				<u-form-item label="是否自主创业" prop="adc113" label-width="150" v-if="formFieldsVisibility.adc113"
					...
					<mini-picker :disabled="isDisabled" placeholder="请选择是否自主创业" selectPrompt="请选择是否自主创业"
						collection="YESORNO" v-model="infoForm.adc113"
						@change="fromChange($event, 'infoForm', 'adc113')"></mini-picker>
				</u-form-item>
				...
				<u-form-item label="是否签订劳动合同" prop="ycc03r" label-width="180" required>
					<mini-picker :disabled="isDisabled" placeholder="请选择是否签订劳动合同" selectPrompt="请选择是否签订劳动合同"
						collection="YESORNO" v-model="infoForm.ycc03r"
				...
				<u-form-item label="灵活就业方式" prop="ycc66h" label-width="150" v-if="formFieldsVisibility.ycc66h">
					<mini-picker :disabled="isDisabled" placeholder="请选择灵活就业方式" selectPrompt="请选择灵活就业方式"
						collection="YCC66H" v-model="infoForm.ycc66h"
						@change="fromChange($event, 'infoForm', 'ycc66h')"></mini-picker>
				</u-form-item>
			...
			query() {
				...
				this.$base.post('', param, (res) => {
					...
					if (res.serviceSuccess) {
						...
						if (res.data.code == '0') {
							console.log('res.data.msg ||', res.data.msg || '查询失败');
			...
			handleConfirm(callback) {
				...
				this.$refs.infoForm.validate(valid => {
					if (valid) {
						...
						formData.aae017 = formData.aae017
						formData.ycc005 = formData.aab299
						// formData.aab301 = formData.aab301
						formData.aac001 = this.userInfo.ext03
						formData.aae017DESC = formData.aae017_desc
